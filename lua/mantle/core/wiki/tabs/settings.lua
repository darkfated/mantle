function CreateMantleSettingsTab()
    ...
    themes:AddChoice('Тёмная монотонная (dark_mono)', 'dark_mono')
    themes:AddChoice('Светлая (light)', 'light')
    themes:AddChoice('Синяя (blue)', 'blue')
    themes:AddChoice('Красная (red)', 'red')
    themes:AddChoice('Зелёная (green)', 'green')
    themes:AddChoice('Оранжевая (orange)', 'orange')
    themes:AddChoice('Фиолетовый (purple)', 'purple')
    themes:AddChoice('Кофейная (coffee)', 'coffee')
    themes:AddChoice('Ледяная (ice)', 'ice')
    themes:AddChoice('Винная (wine)', 'wine')
    themes:AddChoice('Фиалковая (violet)', 'violet')
    themes:AddChoice('Моховая (moss)', 'moss')
    themes:AddChoice('Коралловая (coral)', 'coral')

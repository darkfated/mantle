...
local function runScripts()
	...
	Mantle.run_cl("core/vgui_elements/scroll.lua")
	...
	Mantle.run_cl("core/vgui_elements/tooltip.lua")
	Mantle.run_cl("core/vgui_elements/tree_node.lua")
	Mantle.run_cl("core/vgui_elements/tree.lua")

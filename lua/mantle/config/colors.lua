Mantle.ui.registerTheme('dark', 'Тёмная (dark)', {
    header = Color(34, 35, 39),
    header_text = Color(165, 170, 180),
    background = Color(18, 19, 22),
    background_alpha = Color(18, 19, 22, 245),
    background_panelpopup = Color(23, 24, 28, 170),

    button = Color(44, 46, 52),
    button_shadow = Color(0, 0, 0, 30),
    button_hovered = Color(60, 63, 72),

    category = Color(37, 39, 44),
    category_opened = Color(37, 39, 44, 0),

    theme = Color(86, 132, 235),
    ...
    toggle = Color(44, 46, 52),

    focus_panel = Color(42, 44, 50, 200),
    hover = Color(67, 76, 102),
...
Mantle.ui.registerTheme('dark_mono', 'Тёмная монотонная (dark_mono)', {
    header = Color(34, 35, 39),
    header_text = Color(165, 170, 180),
    background = Color(18, 19, 22),
    background_alpha = Color(18, 19, 22, 245),
...
Mantle.ui.registerTheme('light', 'Светлая (light)', {
    ...
    blur_shadow = Color(105, 112, 128, 30),
...
Mantle.ui.registerTheme('red', 'Красная (red)', {
...
Mantle.ui.registerTheme('green', 'Зелёная (green)', {
...
Mantle.ui.registerTheme('orange', 'Оранжевая (orange)', {
    ...
    circle_shadow = Color(0, 0, 0, 20),
    ripple = Color(0, 0, 0, 40),
    blur_shadow = Color(130, 116, 102, 30),
    tab_hover = Color(0, 0, 0, 14),
    icon = Color(255, 255, 255),
    status_disconnect = Color(210, 65, 65),
    status_bot = Color(70, 150, 220),
...
Mantle.ui.registerTheme('coffee', 'Кофейная (coffee)', {
...
Mantle.ui.registerTheme('ice', 'Ледяная (ice)', {
    ...
    circle_shadow = Color(0, 0, 0, 20),
    ripple = Color(0, 0, 0, 40),
    blur_shadow = Color(105, 125, 145, 30),
    tab_hover = Color(0, 0, 0, 14),
    icon = Color(255, 255, 255),
    status_disconnect = Color(210, 65, 65),
    status_bot = Color(70, 150, 220),
...
Mantle.ui.registerTheme('violet', 'Фиалковая (violet)', {
...
Mantle.ui.registerTheme('moss', 'Моховая (moss)', {
...
Mantle.ui.registerTheme('coral', 'Коралловая (coral)', {
